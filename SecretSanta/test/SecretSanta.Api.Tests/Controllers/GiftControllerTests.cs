...
namespace SecretSanta.Api.Tests.Controllers
{
    ...
    public class GiftControllerTests
    {
        ...
        public async Task GetGiftForUser_ReturnsUsersFromService()
        {
            ...
            OkObjectResult result = await controller.GetGiftForUserAsync(4) as OkObjectResult;
        ...
        public async Task GetGiftForUser_RequiresPositiveUserId()
        {
            ...
            IActionResult result = await controller.GetGiftForUserAsync(-1) as NotFoundResult;
